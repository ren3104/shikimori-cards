...
BINGO_TASKS = [
    ...
    BingoTask("Посмотри аниме, основанное на новелле / ранобэ.", WatchedAnimeCheck & AnimeAdaptationCheck(["novel", "ranobe"]), 0.5, ["anime"]),
    # Информация
    ...
    # Жанры
    BingoTask("Посмотри аниме в жанре авангард.", WatchedAnimeCheck & GenresCheck("Авангард"), 0.1, ["anime"]),
    BingoTask("Прочитай мангу / ранобэ в жанре авангард.", ReadMangaRanobeCheck & GenresCheck("Авангард"), 0.1, ["manga", "ranobe"]),
    BingoTask("Посмотри аниме в жанре гурман.", WatchedAnimeCheck & GenresCheck("Гурман"), 0.1, ["anime"]),
    BingoTask("Прочитай мангу / ранобэ в жанре гурман.", ReadMangaRanobeCheck & GenresCheck("Гурман"), 0.1, ["manga", "ranobe"]),
    BingoTask("Посмотри аниме в жанре драма.", WatchedAnimeCheck & GenresCheck("Драма"), 0.5, ["anime"]),
    BingoTask("Прочитай мангу / ранобэ в жанре драма.", ReadMangaRanobeCheck & GenresCheck("Драма"), 0.5, ["manga", "ranobe"]),
    ...
    BingoTask("Посмотри аниме в жанре повседневность.", WatchedAnimeCheck & GenresCheck("Повседневность"), 0.5, ["anime"]),
    BingoTask("Прочитай мангу / ранобэ в жанре повседневность.", ReadMangaRanobeCheck & GenresCheck("Повседневность"), 0.5, ["manga", "ranobe"]),
    BingoTask("Посмотри аниме в жанре приключения.", WatchedAnimeCheck & GenresCheck("Приключения"), 0.5, ["anime"]),
    BingoTask("Прочитай мангу / ранобэ в жанре приключения.", ReadMangaRanobeCheck & GenresCheck("Приключения"), 0.5, ["manga", "ranobe"]),
    BingoTask("Посмотри аниме в жанре романтика.", WatchedAnimeCheck & GenresCheck("Романтика"), 0.5, ["anime"]),
    BingoTask("Прочитай мангу / ранобэ в жанре романтика.", ReadMangaRanobeCheck & GenresCheck("Романтика"), 0.5, ["manga", "ranobe"]),
    BingoTask("Посмотри аниме в жанре сверхъестественное.", WatchedAnimeCheck & GenresCheck("Сверхъестественное"), 0.5, ["anime"]),
    BingoTask("Прочитай мангу / ранобэ в жанре сверхъестественное.", ReadMangaRanobeCheck & GenresCheck("Сверхъестественное"), 0.5, ["manga", "ranobe"]),
    BingoTask("Посмотри аниме в жанре спорт.", WatchedAnimeCheck & GenresCheck("Спорт"), 0.1, ["anime"]),
    BingoTask("Прочитай мангу / ранобэ в жанре спорт.", ReadMangaRanobeCheck & GenresCheck("Спорт"), 0.1, ["manga", "ranobe"]),
    BingoTask("Посмотри аниме в жанре тайна.", WatchedAnimeCheck & GenresCheck("Тайна"), 0.3, ["anime"]),
    BingoTask("Прочитай мангу / ранобэ в жанре тайна.", ReadMangaRanobeCheck & GenresCheck("Тайна"), 0.3, ["manga", "ranobe"]),
    BingoTask("Посмотри аниме в жанре триллер.", WatchedAnimeCheck & GenresCheck("Триллер"), 0.1, ["anime"]),
    BingoTask("Прочитай мангу / ранобэ в жанре триллер.", ReadMangaRanobeCheck & GenresCheck("Триллер"), 0.1, ["manga", "ranobe"]),
    BingoTask("Посмотри аниме в жанре ужасы.", WatchedAnimeCheck & GenresCheck("Ужасы"), 0.1, ["anime"]),
    BingoTask("Прочитай мангу / ранобэ в жанре ужасы.", ReadMangaRanobeCheck & GenresCheck("Ужасы"), 0.1, ["manga", "ranobe"]),
    BingoTask("Посмотри аниме в жанре фантастика.", WatchedAnimeCheck & GenresCheck("Фантастика"), 0.5, ["anime"]),
    BingoTask("Прочитай мангу / ранобэ в жанре фантастика.", ReadMangaRanobeCheck & GenresCheck("Фантастика"), 0.5, ["manga", "ranobe"]),
    BingoTask("Посмотри аниме в жанре фэнтези.", WatchedAnimeCheck & GenresCheck("Фэнтези"), 0.5, ["anime"]),
    BingoTask("Прочитай мангу / ранобэ в жанре фэнтези.", ReadMangaRanobeCheck & GenresCheck("Фэнтези"), 0.5, ["manga", "ranobe"]),
    BingoTask("Посмотри аниме в жанре экшен.", WatchedAnimeCheck & GenresCheck("Экшен"), 0.5, ["anime"]),
    BingoTask("Прочитай мангу / ранобэ в жанре экшен.", ReadMangaRanobeCheck & GenresCheck("Экшен"), 0.5, ["manga", "ranobe"]),
    # Разное
